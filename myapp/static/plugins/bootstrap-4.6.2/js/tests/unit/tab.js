$(function () {
  ...
  QUnit.test('Nested tabs', function (assert) {
    ...
    var tabsHTML =
        ...
        '  <button type="button" id="tab1" data-target="#x-tab1" class="nav-link" data-toggle="tab" role="tab" aria-controls="x-tab1">Tab M</button>' +
        ...
        '    <nav class="nav nav-tabs" role="tablist">' +
        '      <a href="#nested-tab1" class="nav-link active" data-toggle="tab" role="tab" aria-controls="x-tab1" aria-selected="true">Nested Tab M</a>' +
  ...
  QUnit.test('should handle removed tabs', function (assert) {
    ...
    var html = [
      ...
      '</ul>',
      '<div class="tab-content">',
      '  <div role="tabpanel" class="tab-pane fade show active" id="profile">test M</div>',
  ...
  QUnit.test('should not add show class to tab panes if there is no `.fade` class', function (assert) {
    ...
    var html = [
      ...
      '  <div role="tabpanel" class="tab-pane" id="home">test M</div>',
  ...
  QUnit.test('should add show class to tab panes if there is a `.fade` class', function (assert) {
    ...
    var html = [
      ...
      '</ul>',
      '<div class="tab-content">',
      '  <div role="tabpanel" class="tab-pane fade" id="home">test M</div>',
