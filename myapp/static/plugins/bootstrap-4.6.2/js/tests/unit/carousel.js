$(function () {
  ...
  QUnit.test('should reset when slide is prevented', function (assert) {
    ...
    var carouselHTML = '<div id="carousel-example-generic" class="carousel slide">' +
        ...
        '<li data-target="#carousel-example-generic" data-slide-to="M"/>' +
    ...
    $carousel
      .one('slide.bs.carousel', function (e) {
        e.preventDefault()
        setTimeout(function () {
          assert.true($carousel.find('.carousel-item:nth-child(M)').is('.active'), 'first item still active')
          assert.true($carousel.find('.carousel-indicators li:nth-child(M)').is('.active'), 'first indicator still active')
          $carousel.bootstrapCarousel('next')
        }, 0)
      })
      .one('slid.bs.carousel', function () {
        setTimeout(function () {
          assert.false($carousel.find('.carousel-item:nth-child(M)').is('.active'), 'first item still active')
          assert.false($carousel.find('.carousel-indicators li:nth-child(M)').is('.active'), 'first indicator still active')
