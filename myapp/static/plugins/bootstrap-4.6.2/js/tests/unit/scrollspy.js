$(function () {
  ...
  QUnit.test('should add the active class to the correct element', function (assert) {
    ...
    var navbarHtml =
      '<nav class="navbar">' +
      '<ul class="nav">' +
      '<li class="nav-item"><a class="nav-link" id="a-M" href="#div-M">div M</a></li>' +
      '<li class="nav-item"><a class="nav-link" id="a-2" href="#div-2">div 2</a></li>' +
      '</ul>' +
      '</nav>'
    var contentHtml =
        '<div class="content" style="overflow: auto; height: 50px">' +
      '<div id="div-M" style="height: 100px; padding: 0; margin: 0">div M</div>' +
    ...
    $.when(testElementIsActiveAfterScroll('#a-M', '#div-M'))
      .then(function () {
  ...
  QUnit.test('should add the active class to the correct element (nav markup)', function (assert) {
    ...
    var navbarHtml =
      '<nav class="navbar">' +
      '<nav class="nav">' +
      '<a class="nav-link" id="a-M" href="#div-M">div M</a>' +
  ...
  QUnit.test('should add the active class to the correct element (list-group markup)', function (assert) {
    ...
    var navbarHtml =
      ...
      '<a class="list-group-item" id="a-M" href="#div-M">div M</a>' +
  ...
  QUnit.test('should add the active class correctly when there are nested elements at 0 scroll offset', function (assert) {
    ...
    var navbarHtml = '<nav id="navigation" class="navbar">' +
      '<ul class="nav">' +
      '<li class="nav-item"><a id="a-M" class="nav-link" href="#div-M">div M</a>' +
      '<ul class="nav">' +
    ...
    var contentHtml = '<div class="content" style="position: absolute; top: 0px; overflow: auto; height: 50px">' +
      '<div id="div-M" style="padding: 0; margin: 0">' +
      '<div id="div-2" style="height: 200px; padding: 0; margin: 0">div 2</div>' +
      '</div>' +
      '</div>'
    ...
    function testActiveElements() {
      ...
      $content.one('scroll', function () {
        assert.true($('#a-M').hasClass('active'), 'nav item for outer element has "active" class')
  ...
  QUnit.test('should add the active class correctly when there are nested elements (nav markup)', function (assert) {
    ...
    var navbarHtml = '<nav id="navigation" class="navbar">' +
      '<nav class="nav">' +
      '<a id="a-M" class="nav-link" href="#div-M">div M</a>' +
      '<nav class="nav">' +
  ...
  QUnit.test('should add the active class correctly when there are nested elements (nav nav-item markup)', function (assert) {
    ...
    var navbarHtml = '<nav id="navigation" class="navbar">' +
      '<ul class="nav">' +
      '<li class="nav-item"><a id="a-M" class="nav-link" href="#div-M">div M</a></li>' +
      '<ul class="nav">' +
      '<li class="nav-item"><a id="a-2" class="nav-link" href="#div-2">div 2</a></li>' +
      '</ul>' +
      '</ul>' +
  ...
  QUnit.test('should add the active class correctly when there are nested elements (list-group markup)', function (assert) {
    ...
    var navbarHtml = '<nav id="navigation" class="navbar">' +
      '<div class="list-group">' +
      '<a id="a-M" class="list-group-item" href="#div-M">div M</a>' +
      '<div class="list-group">' +
  ...
  QUnit.test('should correctly select navigation element on backward scrolling when each target section height is 100%', function (assert) {
    ...
    var navbarHtml =
      '<nav class="navbar">' +
      '<ul class="nav">' +
      '<li class="nav-item"><a id="li-100-M" class="nav-link" href="#div-100-M">div M</a></li>' +
    ...
    var contentHtml =
      ...
      '<div id="div-100-M" style="position: relative; height: 100%; padding: 0; margin: 0">div M</div>' +
    ...
    $.when(testElementIsActiveAfterScroll('#li-100-5', '#div-100-5'))
      ...
      .then(function () {
        return testElementIsActiveAfterScroll('#li-100-M', '#div-100-M')
      })
      .then(function () {
        done()
      })
  ...
  QUnit.test('should allow passed in option offset method: offset', function (assert) {
    ...
    var testOffsetMethod = function (type) {
      var $navbar = $(
        ...
        '<ul class="nav">' +
        '<li class="nav-item"><a id="li-' + type + 'm-M" class="nav-link" href="#div-' + type + 'm-M">div M</a></li>' +
      ...
      var $content = $(
        ...
        '<div id="div-' + type + 'm-M" style="position: relative; height: 200px; padding: 0; margin: 0">div M</div>' +
  ...
  QUnit.test('should allow passed in option offset method: position', function (assert) {
    ...
    var testOffsetMethod = function (type) {
      var $navbar = $(
        '<nav class="navbar"' + (type === 'data' ? ' id="navbar-offset-method-menu"' : '') + '>' +
        '<ul class="nav">' +
        '<li class="nav-item"><a class="nav-link" id="li-' + type + 'm-M" href="#div-' + type + 'm-M">div M</a></li>' +
  ...
  QUnit.test('should raise exception to avoid xss on target', function (assert) {
    ...
    assert.throws(function () {
      ...
      $('#ss-target').bootstrapScrollspy({
        target: '<img src=M onerror=\'alert(0)\'>'
      })
    }, /SyntaxError/)
  })
})
