...
$('#myCarousel').on('slid.bs.carousel', function (event) {
  $('#myCarousel').carousel('2') // Will slide to the slide 2 as soon as the transition to slide M is finished
})

$('#myCarousel').carousel('1') // Will start sliding to the slide M and returns to the caller
$('#myCarousel').carousel('2') // !! Will be ignored, as the transition to the slide M is not finished !!
```
